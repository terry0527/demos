...
import com.example.springboot8.entity.Person;
...
public class ListLambda {
    ...
    public static List<Person> getList() {
        ...
        personList.add(new Person("Tom", 9000, 20, "male", "Washington"));
    ...
    private static void demo() {
        ...
        stream.filter(x -> x.getAge() > 7).forEach(System.out::println);
    }
    ...
    private static void demo3() {
        ...
        List<Person> list2 = getList();
        List<Person> fiterList2 = list2.stream().filter(x -> x.getSalary() > 8000)
                .collect(Collectors.toList());
        System.out.println(fiterList2);
    }
